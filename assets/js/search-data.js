...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio-main/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio-main/projects/";
          },
        },{id: "nav-repositories",
          title: "repositories",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio-main/repositories/";
          },
        },{id: "nav-cv",
          title: "CV",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio-main/people/";
          },
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/al-folio-main/books/";
              },
            },{id: "dropdown-blog",
              title: "blog",
              description: "",
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/al-folio-main/books/the_godfather/";
