...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio-main/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio-main/cv/";
          },
        },{id: "nav-teaching",
          title: "teaching",
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2024/code-diff/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2024/advanced-images/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2024/geojson-map/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2024/echarts/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2023/sidebar-table-of-contents/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2023/tables/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2021/distill/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio-main/blog/2015/disqus-comments/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/al-folio-main/news/announcement_2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/1_project/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/4_project/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/8_project/";
            },},{id: "projects-project-9",
          title: 'project 9',
          description: "another project with an image 🎉",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio-main/projects/9_project/";
            },},{id: "teachings-data-science-fundamentals",
          title: 'Data Science Fundamentals',
          description: "This course covers the foundational aspects of data science, including data collection, cleaning, analysis, and visualization. Students will learn practical skills for working with real-world datasets.",
          section: "Teachings",handler: () => {
              window.location.href = "/al-folio-main/teachings/data-science-fundamentals/";
